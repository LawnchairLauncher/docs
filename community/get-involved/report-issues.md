...
Before reporting a bug, please check if the issue is already known by checking our [troubleshooting guides](https://app.gitbook.com/s/AIacWTbuc2FAEgCbTojQ/troubleshooting) and searching [our existing issues](https://github.com/LawnchairLauncher/lawnchair/issues).
